                ...
                <nav class=" px-6 max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global" >
                    ...
                    <div id="navbar-image-and-text-2" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
                        <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
                            <a class="flex items-center font-medium text-gray-600 hover:text-orange-600">
                                <FaSpotify className='mr-1'/> Login with spotify
                            </a>
                            <a class="flex items-center font-medium text-gray-600 hover:text-orange-600 dark:text-gray-400 dark:hover:text-gray-500" href="#"><BsJustifyLeft className='mr-1'/> About</a>
                            <a class="flex items-center font-medium text-gray-600 hover:text-orange-600 dark:text-gray-400 dark:hover:text-gray-500" href="#"><GrContact className='mr-1'/>Contact</a>
                        </div>
                    </div>
                </nav>
            </header>
